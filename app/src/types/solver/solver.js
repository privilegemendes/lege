...
class Solver {
    ...
    static partialCopyBoard(board) {
        ...
        b.data = JSON.parse(JSON.stringify(board.data));
        return b;
    }
     ...
     * @param {Number} boardMaxValue - The maximum value allowed on the board
    ...
    static simpleSolveLine(line, clues, boardMaxValue, simpleSolveCrossLines = true) {
        ...
        function toKnownArray(value, useWholeBoardMax = false) {
            ...
            if (value === null) {
                if (useWholeBoardMax) {
                    ...
                    let r = JSON.parse(JSON.stringify(lineValues));
                    r.push(0);
                    return r;
                }
            }
        ...
        function trackPossibleLineSolution(curLine) {
            if (!knownCells) {
                knownCells = JSON.parse(JSON.stringify(curLine));
                return;
            }
        ...
        tryCluePositions(JSON.parse(JSON.stringify(line)), 0, 0);
